        ...
        children: [
          {
            ...
            meta: { title: '用户管理', permission: 'menu:system:user' },
          },
          {
            path: 'roles',
            name: 'RoleManagement',
            component: () => import('@/views/system/role/index.vue'),
            meta: { title: '角色管理', permission: 'menu:system:role' },
          },
          {
            path: 'permissions',
            name: 'PermissionManagement',
            component: () => import('@/views/system/permission/index.vue'),
            meta: { title: '权限管理', permission: 'menu:system:permission' },
          },
          {
            path: 'applications',
          ...
          },
          {
            ...
            meta: { title: '审计日志', permission: 'menu:system:audit' },
          },
        ],
      },
    ],
